...
def get_all_collection_transfers_sql(nft_token_address):
    """
...
def get_all_sales(all_data=None, collection_address=None):
    """
...
def get_all_transfers(all_data=None, collection_address=None):
    """
